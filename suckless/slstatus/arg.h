...
<head>
	...
	<title>dwm-setup/suckless/slstatus/arg.h an main - justaguylinux/dwm-setup - Codeberg.org</title>
...
<script src="/assets/js/webcomponents.js?v=13.0.0-dev-623-c059966a~gitea-1.22.0"></script>
	...
	<meta property="og:title" content="dwm-setup/suckless/slstatus/arg.h an main">


	<meta property="og:url" content="https://codeberg.org//justaguylinux/dwm-setup/src/branch/main/suckless/slstatus/arg.h">
...
<nav id="navbar" aria-label="Navigationsleiste">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fjustaguylinux%2fdwm-setup%2fsrc%2fbranch%2fmain%2fsuckless%2fslstatus%2farg.h">
...
<div role="main" aria-label="dwm-setup/suckless/slstatus/arg.h an main" class="page-content repository file list ">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/suckless\/slstatus\/arg.h',
		'tagURLPrefix': '\/justaguylinux\/dwm-setup/src/tag/',
		'tagURLSuffix': '/suckless\/slstatus\/arg.h',
		'repoLink': "/justaguylinux/dwm-setup",
		'treePath': "suckless/slstatus/arg.h",
		...
		<button class="branch-dropdown-button gt-ellipsis ui basic small compact button tw-flex tw-m-0">
			...
			<svg viewBox="0 0 16 16" class="dropdown icon svg octicon-triangle-down" aria-hidden="true" width="14" height="14"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427"/></svg>
					...
					<span class="breadcrumb repo-path tw-ml-1">
						<a class="section" href="/justaguylinux/dwm-setup/src/branch/main" title="dwm-setup">dwm-setup</a><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless" title="suckless">suckless</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless/slstatus" title="slstatus">slstatus</a></span><span class="breadcrumb-divider">/</span><span class="active section" title="arg.h">arg.h</span>
								<button class="btn interact-fg tw-p-2" data-clipboard-text="suckless/slstatus/arg.h" data-tooltip-content="Pfad kopieren"><svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg></button></span>
	...
	<h4 class="file-header ui top attached header tw-flex tw-items-center tw-justify-between tw-flex-wrap">
		...
		<div class="file-header-right file-actions tw-flex tw-items-center tw-flex-wrap">
				...
				<div class="ui buttons tw-mr-1">
					...
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/arg.h">Originalformat</a>
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/arg.h">Permalink</a>
					
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/blame/branch/main/suckless/slstatus/arg.h">Blame</a>
					
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/commits/branch/main/suckless/slstatus/arg.h">Verlauf</a>
					
				</div>
				<a download class="btn-octicon" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/arg.h" data-tooltip-content="Datei herunterladen">
				...
				<a href="#" id="copy-content" class="btn-octicon " data-tooltip-content="Inhalt kopieren">
					<svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg>
						...
						<a class="btn-octicon" href="/justaguylinux/dwm-setup/rss/branch/main/suckless/slstatus/arg.h" data-tooltip-content="RSS-Feed">
	...
	<div class="ui bottom attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L2" class="lines-code chroma"><code class="code-inner"><span class="cp">#</span><span class="cp">ifndef ARG_H</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define ARG_H</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L5" class="lines-code chroma"><code class="code-inner"><span class="k">extern</span> <span class="kt">char</span> <span class="o">*</span><span class="n">argv0</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L7" class="lines-code chroma"><code class="code-inner"><span class="cm">/* int main(int argc, char *argv[]) */</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L8" class="lines-code chroma"><code class="code-inner"><span class="cp">#</span><span class="cp">define ARGBEGIN for (argv0 = *argv, *argv ? (argc--, argv++) : ((void *)0);      \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L9" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                      *argv &amp;&amp; (*argv)[0] == &#39;-&#39; &amp;&amp; (*argv)[1]; argc--, argv++) { \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L10" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 	int i_, argused_;                                         \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L11" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 	if ((*argv)[1] == &#39;-&#39; &amp;&amp; !(*argv)[2]) {                   \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L12" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 		argc--, argv++;                                   \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L13" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 		break;                                            \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L14" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 	}                                                         \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 	for (i_ = 1, argused_ = 0; (*argv)[i_]; i_++) {           \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">				switch ((*argv)[i_])</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L17" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define ARGEND   		if (argused_) {                                   \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 			if ((*argv)[i_ + 1]) {                    \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L19" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 				break;                            \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L20" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 			} else {                                  \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L21" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 				argc--, argv++;                   \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L24" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 		}                                                 \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L25" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 	}                                                         \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L26" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                 }</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L27" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define ARGC()    ((*argv)[i_])</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L28" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define ARGF_(x) (((*argv)[i_ + 1]) ? (argused_ = 1, &amp;((*argv)[i_ + 1])) :        \</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L29" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">                  (*(argv + 1))     ? (argused_ = 1, *(argv + 1))        : (x))</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L30" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define EARGF(x) ARGF_(((x), exit(1), (char *)0))</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L31" class="lines-code chroma"><code class="code-inner"><span class="cp"></span><span class="cp">#</span><span class="cp">define ARGF()   ARGF_((char *)0)</span><span class="cp">
</span></code></td>
						</tr>
				...
				<div class="code-line-menu tippy-target">
						...
						<a class="item ref-in-new-issue" role="menuitem" data-url-issue-new="/justaguylinux/dwm-setup/issues/new" data-url-param-body-link="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/arg.h" rel="nofollow noindex">In neuem Issue referenzieren</a>
					
					<a class="item view_git_blame" role="menuitem" href="/justaguylinux/dwm-setup/blame/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/arg.h">„git blame“ ansehen</a>
					<a class="item copy-line-permalink" role="menuitem" data-url="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/arg.h">Permalink kopieren</a>
				</div>
