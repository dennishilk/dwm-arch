...
<head>
	...
	<title>dwm-setup/suckless/slstatus/config.def.h an main - justaguylinux/dwm-setup - Codeberg.org</title>
...
<script src="/assets/js/webcomponents.js?v=13.0.0-dev-623-c059966a~gitea-1.22.0"></script>
	...
	<meta property="og:title" content="dwm-setup/suckless/slstatus/config.def.h an main">


	<meta property="og:url" content="https://codeberg.org//justaguylinux/dwm-setup/src/branch/main/suckless/slstatus/config.def.h">
...
<nav id="navbar" aria-label="Navigationsleiste">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fjustaguylinux%2fdwm-setup%2fsrc%2fbranch%2fmain%2fsuckless%2fslstatus%2fconfig.def.h">
...
<div role="main" aria-label="dwm-setup/suckless/slstatus/config.def.h an main" class="page-content repository file list ">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/suckless\/slstatus\/config.def.h',
		'tagURLPrefix': '\/justaguylinux\/dwm-setup/src/tag/',
		'tagURLSuffix': '/suckless\/slstatus\/config.def.h',
		'repoLink': "/justaguylinux/dwm-setup",
		'treePath': "suckless/slstatus/config.def.h",
		...
		<button class="branch-dropdown-button gt-ellipsis ui basic small compact button tw-flex tw-m-0">
			...
			<svg viewBox="0 0 16 16" class="dropdown icon svg octicon-triangle-down" aria-hidden="true" width="14" height="14"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427"/></svg>
					...
					<span class="breadcrumb repo-path tw-ml-1">
						<a class="section" href="/justaguylinux/dwm-setup/src/branch/main" title="dwm-setup">dwm-setup</a><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless" title="suckless">suckless</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless/slstatus" title="slstatus">slstatus</a></span><span class="breadcrumb-divider">/</span><span class="active section" title="config.def.h">config.def.h</span>
								<button class="btn interact-fg tw-p-2" data-clipboard-text="suckless/slstatus/config.def.h" data-tooltip-content="Pfad kopieren"><svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg></button></span>
...
<a href="/justaguylinux/dwm-setup/commit/90f3f7ff5b2a21e05b2869c39e77f02450317e4a" rel="nofollow" class="sha label">
	<span class="shortsha">90f3f7ff5b</span></a>

	

	
	<span class="grey commit-summary" title="Update config.def.h"><span class="message-wrapper"><a href="/justaguylinux/dwm-setup/commit/90f3f7ff5b2a21e05b2869c39e77f02450317e4a" class="default-link muted">Update config.def.h</a></span>
					...
					<div class="text grey age">
						<relative-time prefix="" tense="past" datetime="2025-08-24T14:14:33-04:00" data-tooltip-content data-tooltip-interactive="true">2025-08-24 14:14:33 -04:00</relative-time>
					</div>
	...
	<h4 class="file-header ui top attached header tw-flex tw-items-center tw-justify-between tw-flex-wrap">
		...
		<div class="file-header-right file-actions tw-flex tw-items-center tw-flex-wrap">
				...
				<div class="ui buttons tw-mr-1">
					...
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/config.def.h">Originalformat</a>
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.def.h">Permalink</a>
					
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/blame/branch/main/suckless/slstatus/config.def.h">Blame</a>
					
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/commits/branch/main/suckless/slstatus/config.def.h">Verlauf</a>
					
				</div>
				<a download class="btn-octicon" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/config.def.h" data-tooltip-content="Datei herunterladen">
				...
				<a href="#" id="copy-content" class="btn-octicon " data-tooltip-content="Inhalt kopieren">
					<svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg>
						...
						<a class="btn-octicon" href="/justaguylinux/dwm-setup/rss/branch/main/suckless/slstatus/config.def.h" data-tooltip-content="RSS-Feed">
	...
	<div class="ui bottom attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L3" class="lines-code chroma"><code class="code-inner"><span class="cm">/* interval between updates (in ms) */</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma"><code class="code-inner"><span class="k">const</span> <span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">interval</span> <span class="o">=</span> <span class="mi">1000</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L6" class="lines-code chroma"><code class="code-inner"><span class="cm">/* text to show if no value can be retrieved */</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L7" class="lines-code chroma"><code class="code-inner"><span class="k">static</span> <span class="k">const</span> <span class="kt">char</span> <span class="n">unknown_str</span><span class="p">[</span><span class="p">]</span> <span class="o">=</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">n/a</span><span class="s">&#34;</span><span class="p">;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L9" class="lines-code chroma"><code class="code-inner"><span class="cm">/* maximum output string length */</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L10" class="lines-code chroma"><code class="code-inner"><span class="cp">#</span><span class="cp">define MAXLEN 2048</span><span class="cp">
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L13" class="lines-code chroma"><code class="code-inner"><span class="cm"> * function            description                     argument (example)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L14" class="lines-code chroma"><code class="code-inner"><span class="cm"> *
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma"><code class="code-inner"><span class="cm"> * battery_perc        battery percentage              battery name (BAT0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     NULL on OpenBSD/FreeBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L17" class="lines-code chroma"><code class="code-inner"><span class="cm"> * battery_remaining   battery remaining HH:MM         battery name (BAT0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     NULL on OpenBSD/FreeBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L19" class="lines-code chroma"><code class="code-inner"><span class="cm"> * battery_state       battery charging state          battery name (BAT0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L20" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     NULL on OpenBSD/FreeBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L21" class="lines-code chroma"><code class="code-inner"><span class="cm"> * cat                 read arbitrary file             path
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L22" class="lines-code chroma"><code class="code-inner"><span class="cm"> * cpu_freq            cpu frequency in MHz            NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L23" class="lines-code chroma"><code class="code-inner"><span class="cm"> * cpu_perc            cpu usage in percent            NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L24" class="lines-code chroma"><code class="code-inner"><span class="cm"> * datetime            date and time                   format string (%F %T)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L25" class="lines-code chroma"><code class="code-inner"><span class="cm"> * disk_free           free disk space in GB           mountpoint path (/)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L26" class="lines-code chroma"><code class="code-inner"><span class="cm"> * disk_perc           disk usage in percent           mountpoint path (/)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L27" class="lines-code chroma"><code class="code-inner"><span class="cm"> * disk_total          total disk space in GB          mountpoint path (/)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L28" class="lines-code chroma"><code class="code-inner"><span class="cm"> * disk_used           used disk space in GB           mountpoint path (/)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L29" class="lines-code chroma"><code class="code-inner"><span class="cm"> * entropy             available entropy               NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L30" class="lines-code chroma"><code class="code-inner"><span class="cm"> * gid                 GID of current user             NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L31" class="lines-code chroma"><code class="code-inner"><span class="cm"> * hostname            hostname                        NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L32" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ipv4                IPv4 address                    interface name (eth0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L33" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ipv6                IPv6 address                    interface name (eth0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L34" class="lines-code chroma"><code class="code-inner"><span class="cm"> * kernel_release      `uname -r`                      NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L35" class="lines-code chroma"><code class="code-inner"><span class="cm"> * keyboard_indicators caps/num lock indicators        format string (c?n?)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L36" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     see keyboard_indicators.c
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L37" class="lines-code chroma"><code class="code-inner"><span class="cm"> * keymap              layout (variant) of current     NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L38" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                     keymap
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L39" class="lines-code chroma"><code class="code-inner"><span class="cm"> * load_avg            load average                    NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L40" class="lines-code chroma"><code class="code-inner"><span class="cm"> * netspeed_rx         receive network speed           interface name (wlan0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L41" class="lines-code chroma"><code class="code-inner"><span class="cm"> * netspeed_tx         transfer network speed          interface name (wlan0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L42" class="lines-code chroma"><code class="code-inner"><span class="cm"> * num_files           number of files in a directory  path
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L43" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     (/home/foo/Inbox/cur)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L44" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ram_free            free memory in GB               NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L45" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ram_perc            memory usage in percent         NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L46" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ram_total           total memory size in GB         NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L47" class="lines-code chroma"><code class="code-inner"><span class="cm"> * ram_used            used memory in GB               NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L48" class="lines-code chroma"><code class="code-inner"><span class="cm"> * run_command         custom shell command            command (echo foo)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L49" class="lines-code chroma"><code class="code-inner"><span class="cm"> * swap_free           free swap in GB                 NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L50" class="lines-code chroma"><code class="code-inner"><span class="cm"> * swap_perc           swap usage in percent           NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L51" class="lines-code chroma"><code class="code-inner"><span class="cm"> * swap_total          total swap size in GB           NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L52" class="lines-code chroma"><code class="code-inner"><span class="cm"> * swap_used           used swap in GB                 NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L53" class="lines-code chroma"><code class="code-inner"><span class="cm"> * temp                temperature in degree celsius   sensor file
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L54" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     (/sys/class/thermal/...)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L55" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     NULL on OpenBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L56" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     thermal zone on FreeBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L57" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     (tz0, tz1, etc.)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L58" class="lines-code chroma"><code class="code-inner"><span class="cm"> * uid                 UID of current user             NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L59" class="lines-code chroma"><code class="code-inner"><span class="cm"> * uptime              system uptime                   NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L60" class="lines-code chroma"><code class="code-inner"><span class="cm"> * username            username of current user        NULL
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L61" class="lines-code chroma"><code class="code-inner"><span class="cm"> * vol_perc            OSS/ALSA volume in percent      mixer file (/dev/mixer)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L62" class="lines-code chroma"><code class="code-inner"><span class="cm"> *                                                     NULL on OpenBSD/FreeBSD
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L63" class="lines-code chroma"><code class="code-inner"><span class="cm"> * wifi_essid          WiFi ESSID                      interface name (wlan0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L64" class="lines-code chroma"><code class="code-inner"><span class="cm"> * wifi_perc           WiFi signal in percent          interface name (wlan0)
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L66" class="lines-code chroma"><code class="code-inner"><span class="k">static</span> <span class="k">const</span> <span class="k">struct</span> <span class="n">arg</span> <span class="n">args</span><span class="p">[</span><span class="p">]</span> <span class="o">=</span> <span class="p">{</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L67" class="lines-code chroma"><code class="code-inner">	<span class="cm">/* function format          argument */</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L68" class="lines-code chroma"><code class="code-inner">	<span class="p">{</span> <span class="n">cpu_perc</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">^c#ff6b6b^ 󰻠 ^c#FFFFFF^%s%% </span><span class="s">&#34;</span><span class="p">,</span> <span class="nb">NULL</span> <span class="p">}</span><span class="p">,</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L69" class="lines-code chroma"><code class="code-inner">	<span class="p">{</span> <span class="n">ram_perc</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">^c#4fc3f7^ 󰍛 ^c#FFFFFF^%s%% </span><span class="s">&#34;</span><span class="p">,</span> <span class="nb">NULL</span> <span class="p">}</span><span class="p">,</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L70" class="lines-code chroma"><code class="code-inner">	<span class="p">{</span> <span class="n">disk_perc</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">^c#ffc107^ 󰋊 ^c#FFFFFF^%s%% </span><span class="s">&#34;</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">/</span><span class="s">&#34;</span> <span class="p">}</span><span class="p">,</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L71" class="lines-code chroma"><code class="code-inner">	<span class="p">{</span> <span class="n">datetime</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">^c#80bfff^ 󰸗 ^c#FFFFFF^%s </span><span class="s">&#34;</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">%a %b %-d</span><span class="s">&#34;</span> <span class="p">}</span><span class="p">,</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L72" class="lines-code chroma"><code class="code-inner">	<span class="p">{</span> <span class="n">datetime</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">^c#9c27b0^ 󰥔 ^c#FFFFFF^%s  </span><span class="s">&#34;</span><span class="p">,</span> <span class="sa"></span><span class="s">&#34;</span><span class="s">%-l:%M %p</span><span class="s">&#34;</span> <span class="p">}</span><span class="p">,</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L73" class="lines-code chroma"><code class="code-inner">	<span class="p">}</span><span class="p">;</span>
</code></td>
						</tr>
				...
				<div class="code-line-menu tippy-target">
						...
						<a class="item ref-in-new-issue" role="menuitem" data-url-issue-new="/justaguylinux/dwm-setup/issues/new" data-url-param-body-link="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.def.h" rel="nofollow noindex">In neuem Issue referenzieren</a>
					
					<a class="item view_git_blame" role="menuitem" href="/justaguylinux/dwm-setup/blame/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.def.h">„git blame“ ansehen</a>
					<a class="item copy-line-permalink" role="menuitem" data-url="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.def.h">Permalink kopieren</a>
				</div>
