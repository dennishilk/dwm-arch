...
<head>
	...
	<title>dwm-setup/suckless/st/config.mk an main - justaguylinux/dwm-setup - Codeberg.org</title>
...
<script src="/assets/js/webcomponents.js?v=13.0.0-dev-623-c059966a~gitea-1.22.0"></script>
	...
	<meta property="og:title" content="dwm-setup/suckless/st/config.mk an main">


	<meta property="og:url" content="https://codeberg.org//justaguylinux/dwm-setup/src/branch/main/suckless/st/config.mk">
...
<nav id="navbar" aria-label="Navigationsleiste">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fjustaguylinux%2fdwm-setup%2fsrc%2fbranch%2fmain%2fsuckless%2fst%2fconfig.mk">
...
<div role="main" aria-label="dwm-setup/suckless/st/config.mk an main" class="page-content repository file list ">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/suckless\/st\/config.mk',
		'tagURLPrefix': '\/justaguylinux\/dwm-setup/src/tag/',
		'tagURLSuffix': '/suckless\/st\/config.mk',
		'repoLink': "/justaguylinux/dwm-setup",
		'treePath': "suckless/st/config.mk",
		...
		<button class="branch-dropdown-button gt-ellipsis ui basic small compact button tw-flex tw-m-0">
			...
			<svg viewBox="0 0 16 16" class="dropdown icon svg octicon-triangle-down" aria-hidden="true" width="14" height="14"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427"/></svg>
					...
					<span class="breadcrumb repo-path tw-ml-1">
						<a class="section" href="/justaguylinux/dwm-setup/src/branch/main" title="dwm-setup">dwm-setup</a><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless" title="suckless">suckless</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless/st" title="st">st</a></span><span class="breadcrumb-divider">/</span><span class="active section" title="config.mk">config.mk</span>
								<button class="btn interact-fg tw-p-2" data-clipboard-text="suckless/st/config.mk" data-tooltip-content="Pfad kopieren"><svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg></button></span>
	...
	<h4 class="file-header ui top attached header tw-flex tw-items-center tw-justify-between tw-flex-wrap">
		...
		<div class="file-header-right file-actions tw-flex tw-items-center tw-flex-wrap">
				...
				<div class="ui buttons tw-mr-1">
					...
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/st/config.mk">Originalformat</a>
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/st/config.mk">Permalink</a>
					
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/blame/branch/main/suckless/st/config.mk">Blame</a>
					
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/commits/branch/main/suckless/st/config.mk">Verlauf</a>
					
				</div>
				<a download class="btn-octicon" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/st/config.mk" data-tooltip-content="Datei herunterladen">
				...
				<a href="#" id="copy-content" class="btn-octicon " data-tooltip-content="Inhalt kopieren">
					<svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg>
						...
						<a class="btn-octicon" href="/justaguylinux/dwm-setup/rss/branch/main/suckless/st/config.mk" data-tooltip-content="RSS-Feed">
	...
	<div class="ui bottom attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L1" class="lines-code chroma"><code class="code-inner"><span class="c"># st version
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L2" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">VERSION</span> <span class="o">=</span> 0.9.2
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L4" class="lines-code chroma"><code class="code-inner"><span class="c"># Customize below to fit your system
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L5" class="lines-code chroma"><code class="code-inner"><span class="c"></span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L6" class="lines-code chroma"><code class="code-inner"><span class="c"># paths
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L7" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">PREFIX</span> <span class="o">=</span> /usr/local
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L8" class="lines-code chroma"><code class="code-inner"><span class="nv">MANPREFIX</span> <span class="o">=</span> <span class="k">$(</span>PREFIX<span class="k">)</span>/share/man
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L10" class="lines-code chroma"><code class="code-inner"><span class="nv">X11INC</span> <span class="o">=</span> /usr/X11R6/include
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L11" class="lines-code chroma"><code class="code-inner"><span class="nv">X11LIB</span> <span class="o">=</span> /usr/X11R6/lib
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L13" class="lines-code chroma"><code class="code-inner"><span class="nv">PKG_CONFIG</span> <span class="o">=</span> pkg-config
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma"><code class="code-inner"><span class="c"># includes and libs
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">INCS</span> <span class="o">=</span> -I<span class="k">$(</span>X11INC<span class="k">)</span> <span class="se">\
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L17" class="lines-code chroma"><code class="code-inner"><span class="se"></span>       <span class="sb">`</span><span class="k">$(</span>PKG_CONFIG<span class="k">)</span> --cflags fontconfig<span class="sb">`</span> <span class="se">\
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma"><code class="code-inner"><span class="se"></span>       <span class="sb">`</span><span class="k">$(</span>PKG_CONFIG<span class="k">)</span> --cflags freetype2<span class="sb">`</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L19" class="lines-code chroma"><code class="code-inner"><span class="nv">LIBS</span> <span class="o">=</span> -L<span class="k">$(</span>X11LIB<span class="k">)</span> -lm -lrt -lX11 -lutil -lXft <span class="se">\
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L20" class="lines-code chroma"><code class="code-inner"><span class="se"></span>       <span class="sb">`</span><span class="k">$(</span>PKG_CONFIG<span class="k">)</span> --libs fontconfig<span class="sb">`</span> <span class="se">\
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L21" class="lines-code chroma"><code class="code-inner"><span class="se"></span>       <span class="sb">`</span><span class="k">$(</span>PKG_CONFIG<span class="k">)</span> --libs freetype2<span class="sb">`</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L23" class="lines-code chroma"><code class="code-inner"><span class="c"># flags
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L24" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">STCPPFLAGS</span> <span class="o">=</span> -DVERSION<span class="o">=</span><span class="se">\&#34;</span><span class="k">$(</span>VERSION<span class="k">)</span><span class="se">\&#34;</span> -D_XOPEN_SOURCE<span class="o">=</span><span class="m">600</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L25" class="lines-code chroma"><code class="code-inner"><span class="nv">STCFLAGS</span> <span class="o">=</span> <span class="k">$(</span>INCS<span class="k">)</span> <span class="k">$(</span>STCPPFLAGS<span class="k">)</span> <span class="k">$(</span>CPPFLAGS<span class="k">)</span> <span class="k">$(</span>CFLAGS<span class="k">)</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L26" class="lines-code chroma"><code class="code-inner"><span class="nv">STLDFLAGS</span> <span class="o">=</span> <span class="k">$(</span>LIBS<span class="k">)</span> <span class="k">$(</span>LDFLAGS<span class="k">)</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L28" class="lines-code chroma"><code class="code-inner"><span class="c"># OpenBSD:
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L29" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c">#CPPFLAGS = -DVERSION=\&#34;$(VERSION)\&#34; -D_XOPEN_SOURCE=600 -D_BSD_SOURCE
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L30" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c">#LIBS = -L$(X11LIB) -lm -lX11 -lutil -lXft \
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L31" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c">#       `$(PKG_CONFIG) --libs fontconfig` \
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L32" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c">#       `$(PKG_CONFIG) --libs freetype2`
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L33" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c">#MANPREFIX = ${PREFIX}/man
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L34" class="lines-code chroma"><code class="code-inner"><span class="c"></span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L35" class="lines-code chroma"><code class="code-inner"><span class="c"># compiler and linker
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L36" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c"># CC = c99
</span></code></td>
						</tr>
				...
				<div class="code-line-menu tippy-target">
						...
						<a class="item ref-in-new-issue" role="menuitem" data-url-issue-new="/justaguylinux/dwm-setup/issues/new" data-url-param-body-link="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/st/config.mk" rel="nofollow noindex">In neuem Issue referenzieren</a>
					
					<a class="item view_git_blame" role="menuitem" href="/justaguylinux/dwm-setup/blame/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/st/config.mk">„git blame“ ansehen</a>
					<a class="item copy-line-permalink" role="menuitem" data-url="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/st/config.mk">Permalink kopieren</a>
				</div>
