...
<head>
	...
	<title>dwm-setup/suckless/slstatus/config.mk an main - justaguylinux/dwm-setup - Codeberg.org</title>
...
<script src="/assets/js/webcomponents.js?v=13.0.0-dev-623-c059966a~gitea-1.22.0"></script>
	...
	<meta property="og:title" content="dwm-setup/suckless/slstatus/config.mk an main">


	<meta property="og:url" content="https://codeberg.org//justaguylinux/dwm-setup/src/branch/main/suckless/slstatus/config.mk">
...
<nav id="navbar" aria-label="Navigationsleiste">
	...
	<div class="navbar-right ui secondary menu">
			...
			<a class="item" rel="nofollow" href="/user/login?redirect_to=%2fjustaguylinux%2fdwm-setup%2fsrc%2fbranch%2fmain%2fsuckless%2fslstatus%2fconfig.mk">
...
<div role="main" aria-label="dwm-setup/suckless/slstatus/config.mk an main" class="page-content repository file list ">
...
<script type="module">
	const data = {
		...
		'branchURLSuffix': '/suckless\/slstatus\/config.mk',
		'tagURLPrefix': '\/justaguylinux\/dwm-setup/src/tag/',
		'tagURLSuffix': '/suckless\/slstatus\/config.mk',
		'repoLink': "/justaguylinux/dwm-setup",
		'treePath': "suckless/slstatus/config.mk",
		...
		<button class="branch-dropdown-button gt-ellipsis ui basic small compact button tw-flex tw-m-0">
			...
			<svg viewBox="0 0 16 16" class="dropdown icon svg octicon-triangle-down" aria-hidden="true" width="14" height="14"><path d="m4.427 7.427 3.396 3.396a.25.25 0 0 0 .354 0l3.396-3.396A.25.25 0 0 0 11.396 7H4.604a.25.25 0 0 0-.177.427"/></svg>
					...
					<span class="breadcrumb repo-path tw-ml-1">
						<a class="section" href="/justaguylinux/dwm-setup/src/branch/main" title="dwm-setup">dwm-setup</a><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless" title="suckless">suckless</a></span><span class="breadcrumb-divider">/</span><span class="section"><a href="/justaguylinux/dwm-setup/src/branch/main/suckless/slstatus" title="slstatus">slstatus</a></span><span class="breadcrumb-divider">/</span><span class="active section" title="config.mk">config.mk</span>
								<button class="btn interact-fg tw-p-2" data-clipboard-text="suckless/slstatus/config.mk" data-tooltip-content="Pfad kopieren"><svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg></button></span>
	...
	<h4 class="file-header ui top attached header tw-flex tw-items-center tw-justify-between tw-flex-wrap">
		...
		<div class="file-header-right file-actions tw-flex tw-items-center tw-flex-wrap">
				...
				<div class="ui buttons tw-mr-1">
					...
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/config.mk">Originalformat</a>
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.mk">Permalink</a>
					
					
						<a class="ui mini basic button" href="/justaguylinux/dwm-setup/blame/branch/main/suckless/slstatus/config.mk">Blame</a>
					
					<a class="ui mini basic button" href="/justaguylinux/dwm-setup/commits/branch/main/suckless/slstatus/config.mk">Verlauf</a>
					
				</div>
				<a download class="btn-octicon" href="/justaguylinux/dwm-setup/raw/branch/main/suckless/slstatus/config.mk" data-tooltip-content="Datei herunterladen">
				...
				<a href="#" id="copy-content" class="btn-octicon " data-tooltip-content="Inhalt kopieren">
					<svg viewBox="0 0 16 16" class="svg octicon-copy" aria-hidden="true" width="14" height="14"><path d="M0 6.75C0 5.784.784 5 1.75 5h1.5a.75.75 0 0 1 0 1.5h-1.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-1.5a.75.75 0 0 1 1.5 0v1.5A1.75 1.75 0 0 1 9.25 16h-7.5A1.75 1.75 0 0 1 0 14.25Z"/><path d="M5 1.75C5 .784 5.784 0 6.75 0h7.5C15.216 0 16 .784 16 1.75v7.5A1.75 1.75 0 0 1 14.25 11h-7.5A1.75 1.75 0 0 1 5 9.25Zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h7.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25Z"/></svg>
						...
						<a class="btn-octicon" href="/justaguylinux/dwm-setup/rss/branch/main/suckless/slstatus/config.mk" data-tooltip-content="RSS-Feed">
	...
	<div class="ui bottom attached table unstackable segment">
		...
		<div class="file-view code-view">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td rel="L1" class="lines-code chroma"><code class="code-inner"><span class="c"># slstatus version
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L2" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">VERSION</span> <span class="o">=</span> 1.0
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L13" class="lines-code chroma"><code class="code-inner"><span class="c"># flags
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L14" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">CPPFLAGS</span> <span class="o">=</span> -I<span class="k">$(</span>X11INC<span class="k">)</span> -D_DEFAULT_SOURCE -DVERSION<span class="o">=</span><span class="se">\&#34;</span><span class="si">${</span><span class="nv">VERSION</span><span class="si">}</span><span class="se">\&#34;</span>
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L15" class="lines-code chroma"><code class="code-inner"><span class="nv">CFLAGS</span>   <span class="o">=</span> -std<span class="o">=</span>c99 -pedantic -Wall -Wextra -Wno-unused-parameter -Os
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L16" class="lines-code chroma"><code class="code-inner"><span class="nv">LDFLAGS</span>  <span class="o">=</span> -L<span class="k">$(</span>X11LIB<span class="k">)</span> -s
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L17" class="lines-code chroma"><code class="code-inner"><span class="c"># OpenBSD: add -lsndio
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L18" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="c"># FreeBSD: add -lkvm -lsndio
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L19" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">LDLIBS</span>   <span class="o">=</span> -lX11
</code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L21" class="lines-code chroma"><code class="code-inner"><span class="c"># compiler and linker
</span></code></td>
						</tr>
						...
						<tr>
							...
							<td rel="L22" class="lines-code chroma"><code class="code-inner"><span class="c"></span><span class="nv">CC</span> <span class="o">=</span> cc
</code></td>
						</tr>
				...
				<div class="code-line-menu tippy-target">
						...
						<a class="item ref-in-new-issue" role="menuitem" data-url-issue-new="/justaguylinux/dwm-setup/issues/new" data-url-param-body-link="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.mk" rel="nofollow noindex">In neuem Issue referenzieren</a>
					
					<a class="item view_git_blame" role="menuitem" href="/justaguylinux/dwm-setup/blame/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.mk">„git blame“ ansehen</a>
					<a class="item copy-line-permalink" role="menuitem" data-url="/justaguylinux/dwm-setup/src/commit/2a1d3bf690bff7f76924f99136b948b539e84d31/suckless/slstatus/config.mk">Permalink kopieren</a>
				</div>
