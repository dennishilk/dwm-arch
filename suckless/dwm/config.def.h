...
/* vanitygaps expects FORCE_VSPLIT to be defined BEFORE including the file */
#define FORCE_VSPLIT 1  /* 1 will force vertical split */
...
/* ────────────────────────── Dmenu fallback (we map it to rofi) ────────────────────────── */
